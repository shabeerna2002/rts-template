<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="shortlist.aspx.vb" Inherits="RTS.shortlist"  EnableViewState="false" %>
            ...
            <div class="card-content">
                <div class="col s12" style="background-color:#e2e1e1; padding-top:5px">
                    <div class="breadcrumb">
                        <a href="../dashboard.aspx" class="breadcrumb-nav">Home</a> | <a href="../jobs/jobs.aspx" class="breadcrumb-nav">Jobs</a> | Shortlisted Applicants
                ...
                <div class="row no-m-t no-m-b">
                    ...
                    <div class="col s12 m7 l8">
                        ...
                        <a onclick="salert();" class="waves-effect waves-grey btn-flat  padding-12-left-right candidate-bar-button-margin tooltipped" data-position="left" data-delay="50" data-tooltip="Click to approve  Mr. Kevin Pieterson for conducting an interview for this job"><i class="fas fa-clipboard-check"></i> Approve to conduct Interview </a>
                    </div>
                            <ul>
...
<div class="fixed-action-btn" style="bottom: 45px; right: 104px;">
    <a class="btn-floating btn-large waves-effect waves-light green tooltipped" data-position="left" data-delay="50" data-tooltip="Click to Approve  Mr. Kevin Pieterson for conducting an interview" onclick="salert();" >
...
<div class="fixed-action-btn" style="bottom: 45px; right: 40px;">
    <a class="btn-floating btn-large waves-effect waves-light red tooltipped" data-position="left" data-delay="50" data-tooltip="Click to reject  Mr. Kevin Pieterson for this job" onclick="salertReject();">
...
<div id="modal_filter_candidates" class="modal bottom-sheet">
    ...
    <script>
        function salert() {
            swal({
                title: "Approve to conduct Interview?",
                text: "Do you want to approve to conduct an interview.",
                type: "warning",
                ...
                swal("Approved!", "Approved to conduct interview.", "success");
            });
