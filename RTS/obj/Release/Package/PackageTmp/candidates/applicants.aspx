<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="applicants.aspx.vb" Inherits="RTS.applicants"  %>
            ...
            <div class="card-content">
                <div class="col s12" style="background-color:#e2e1e1; padding-top:5px">
                    <div class="breadcrumb">
                        <a href="../dashboard.aspx" class="breadcrumb-nav">Home</a> | <a href="../jobs/jobs.aspx" class="breadcrumb-nav">Jobs</a> | Applicants
                ...
                <div class="row no-m-t no-m-b">
                    ...
                    <div class="col s12 m7 l8">
                        ...
                        <a onclick="salert();" class="waves-effect waves-grey btn-flat  padding-12-left-right candidate-bar-button-margin tooltipped" data-position="left" data-delay="50" data-tooltip="Click to short list Mr. Kevin Pieterson for this job"><i class="fas fa-clipboard-check"></i> Shortlist </a>
                    </div>
                            <ul>
...
<div class="fixed-action-btn" style="bottom: 45px; right: 104px;">
    <a class="btn-floating btn-large waves-effect waves-light green tooltipped" data-position="left" data-delay="50" data-tooltip="Click to short list Mr. Kevin Pieterson for this job" onclick="salert();">
