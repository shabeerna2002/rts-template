<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="security.aspx.vb" Inherits="RTS.security" %>
    ...
    <div class="row no-m-t no-m-b">
                <div class="col s12 m12 l12 no-p-h">
                    <div class="card mailbox-content">
                        ...
                        <a href="../dashboard.aspx" class="breadcrumb-nav">Home</a> | <a href="../jobs/jobs.aspx" class="breadcrumb-nav">Jobs</a> | Security
            ...
            <div class="col s3">
                <div class="card card-light">
                    <div class="card-content">
                        ...
                        <div class="center">
                            <a href="#"><i class="fas fa-user-shield job-interview-icons tooltipped" data-position="bottom" data-delay="50" data-tooltip="Process Security Clearance"></i></a><a href="#"><i class="fas fa-times-circle job-interview-icons tooltipped" data-position="bottom" data-delay="50" data-tooltip="Reject the candidate"></i></a>
                    ...
                    <div class="card-action">
                        ...
                        <span class="lime darken-2 white">Yet to Process</span><br />
            ...
            <div class="col s3">
                <div class="card card-light">
                    <div class="card-content">
                        ...
                        <div class="center"><a href="#"><i class="fas fa-user-shield job-interview-icons tooltipped" data-position="bottom" data-delay="50" data-tooltip="Process Security Clearance"></i></a><a href="#"><i class="fas fa-times-circle job-interview-icons tooltipped" data-position="bottom" data-delay="50" data-tooltip="Reject the candidate"></i></a></div>
                  </div>
                    <div class="card-action">
                        <div class="right history-button-card-view">
            ...
            <div class="col s3">
                <div class="card card-light">
                    <div class="card-content">
                       ...
                       <div class="center"><a href="#"><i class="fas fa-check-circle job-interview-icons tooltipped" data-position="bottom" data-delay="50" data-tooltip="Approve Security Clearance"></i></a><a href="#"><i class="fas fa-times-circle job-interview-icons tooltipped" data-position="bottom" data-delay="50" data-tooltip="Reject the candidate"></i></a></div>
            ...
            <div class="col s3">
                <div class="card card-light">
                    ...
                    <div class="card-action">
                        ...
                        <span class="green darken-2 white">Approved</span>
                        <br />
                        Post : Marketing Analyst
                        <br />
                        Department : Corporate Marketing
